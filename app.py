...
df1 = pd.read_csv('assets/admission_predict_V1.2.csv').head()
model = joblib.load('assets/model_RandF.sav')
#----------------------------------------------------------------------------------------

# Plotting regression result
df = pd.read_csv('assets/admission_predict_V1.2.csv')
